...
namespace Attendance.Application.Interfaces
{
    public interface IAttendanceService
    {
        ...
        Task<Result<PaginatedResponse<AbsentReportDto>>> GetAbsentReportAsync(DateOnly fromDate, DateOnly toDate, int? branchId, int page, int pageSize, int? employeeId);
